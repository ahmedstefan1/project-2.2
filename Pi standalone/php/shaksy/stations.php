...
<html lang="en">
    ...
    <body id="pageTop" onload="loadXMLDoc()">
		...
		<section class="portfolio" id="portfolio">
            ...
            <div class="container">
                ...
                <h1 class="text-center"><span class="light">Weather</span> <span class="extra-bold">Stations</span></h1>

                <div class="zigzag"><i class="fa"><img src="assets\img\ico\stations.png"></img></i></div>
        ...
        </section><!-- /.logos-owl-carousel-wrapper -->
